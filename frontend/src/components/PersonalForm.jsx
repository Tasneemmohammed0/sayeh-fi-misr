    ...
    <form className={styles.form}>
          ...
          <div className={styles.inputWrapper}>
              ...
              <div className={styles.inputWrapper}>
                ...
                <input className={styles.input}  type="text" name="lastname" placeholder="Last Name" value={state.last_name}  onChange={(e)=>dispatch({type:"updateLastname",payload:e.target.value})} />
              ...
              <div className={`${styles.inputWrapper} ${styles.start}`}>
                ...
                <select className={styles.select} name="age" value={state.age} onChange={(e)=>dispatch({type:"updateAge",payload:e.target.value})}>
              ...
              <div className={styles.inputWrapper}>
               ...
               <input className={styles.input}  type="text" name="nationality" placeholder="Nationality" value={state.nationality} onChange={(e)=>dispatch({type:"updateNationality",payload:e.target.value})}/>
           </div>
           <div className={styles.inputWrapper}>
             <label className={`${styles.label} ${styles.marginR} ${styles.specialLabel}`}>Country</label>
             <select required 
                name="country"
                value={state.country}
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <button className={styles.btn} type='submit' onClick={(e) =>handleSubmit(e) }>
                Next <span className={styles.arrow}><FaArrowRight /></span>
              </button>
            </div>

            {error==1 && <div><ErrorMessage error="Please fill all the fields"  fontSize='15px'/>
              </div> 
            }
    </form>
  )
